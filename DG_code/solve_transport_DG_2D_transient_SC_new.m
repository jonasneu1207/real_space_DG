function DG = solve_transport_DG_2D_transient_SC_new(mat, INIT)
    ...
    % Temp = mat.Vg;
    % mat.Vg = mat.Vg(1);
    % DG_solved = solve_self_consistent(mat, 'DG');
    % % 
    % % p    = DG.p;
    % % Esub = DG.Esub;
    % % Vsub = DG.Vsub;
    ...
    %% Prepare mapping matrixto map DG discetization of carrier density onto FV discretization for Poisson
